...
3. (15 points) I have written a program for you to complete. This problem is not to be
included with the menu. Simply print when I run the menu program that it is included
in another project. You are to write a program that outputs the mean, median, and
mode. Your task is to complete the function. This will use structures to pass information
from one function to the print function.
...
I have also supplied the expected outputs you can compare against in a StatResults.txt
file. Note: The only part of the program you are to change is the stat function. Nothing
else is to be touched!
*/
