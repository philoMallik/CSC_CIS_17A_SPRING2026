...
class ActionSpace : public Square { //Inherit from Square class
  ...
  public:
    ...
    //Member functions
    virtual void onLand(Player* player); //function to handle the action when a player lands on the action space (e.g., draw a card, pay tax, etc.)
    virtual void toString() const; //function to print the details of the action space
