...
//Function Prototype
Board readFromFile(const char* filename); //Function to read board configuration from a file and initialize the board accordingly (to be implemented)
...
int main(int argv, char **argc)
{
    ...
    //Initialize Board
    board = readFromFile("board_data.txt"); //Function to read board configuration from a file and initialize the board accordingly (to be implemented)
